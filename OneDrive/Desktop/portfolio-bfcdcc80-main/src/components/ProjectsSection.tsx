...
const projects: Project[] = [
  {
    ...
    title: "MUBS Locator",
    category: "Fintech",
    description: "Find buildings quickly using Google Maps, submit feedback to improve campus facilities, and manage your profile effortlessly.",
    challenge: "Students, Parents and visitors get problems when they try to navigate Makerere University.",
    solution: "Created a minimalist interface with gesture-based navigation and AI-powered insights.",
    results: ["40% increase in daily active users", "65% reduction in support tickets", "4.9★ App Store rating"],
    image: "linear-gradient(135deg, #10b981 0%, #06b6d4 100%)",
    accentColor: "emerald",
    technologies: ["Flutter Frame work", "JavaScript", "Firebase", "React Native"],
    year: "2024",
  },
  {
    id: 2,
    ...
    category: "SaaS",
    description: "An enterprise collaboration platform that brings teams together through seamless communication.",
    challenge: "Remote teams struggled with fragmented tools.",
    solution: "Built an all-in-one platform with real-time collaboration and video conferencing.",
    results: ["200K+ monthly active users", "50% faster project completion", "Series B funded"],
  ...
  },
  {
    ...
    title: "Pulse Health",
    category: "Healthcare",
    description: "A comprehensive health tracking ecosystem that empowers users to take control of their wellness.",
    challenge: "Health data was scattered across multiple apps.",
    solution: "Unified all health metrics in one beautiful dashboard with personalized recommendations.",
  ...
  },
  {
    ...
    category: "E-commerce",
    description: "A next-generation shopping experience that blends physical and digital retail seamlessly.",
    challenge: "Online shopping lacked the tactile experience of in-store browsing.",
    solution: "Implemented AR try-on features and personalized AI recommendations.",
    results: ["35% higher conversion rate", "60% fewer returns", "Best E-commerce UX Award"],
  ...
  },
  {
    ...
    description: "A privacy-first social platform that puts meaningful connections over vanity metrics.",
    challenge: "Users were tired of algorithmic feeds and privacy concerns.",
    solution: "Built a chronological, ad-free experience with end-to-end encryption.",
    results: ["500K signups in first month", "92% privacy satisfaction", "Featured in Wired"],
...
const ProjectsSection = () => {
  ...
  useGSAP(() => {
    if (!sectionRef.current || !horizontalRef.current || !containerRef.current) return;
